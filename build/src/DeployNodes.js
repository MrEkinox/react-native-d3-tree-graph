    ...
    const rectNodes = lodash_1.default.map(nodes, function (n, index) {
        ...
        if (n.name) {
            ...
            return (react_1.default.createElement(react_native_svg_1.G, { key: "tree_" + index },
                ...
                react_1.default.createElement(react_native_svg_1.Image, { x: CoordinatePoints_1.kx(n), y: CoordinatePoints_1.ky(n), width: imageWidth, height: imageHeight, href: n.imageUrl }),
                text));
        }
    });
    return rectNodes;
